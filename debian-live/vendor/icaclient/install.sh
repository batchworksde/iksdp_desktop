...
curl --silent --location https://iksdplinux.s3.amazonaws.com/icaclient_25.05.0.44_"${DEBIAN_ARCH}".deb --output "${BUILD_DIR}"/config/packages.chroot/icaclient_25.03.0.66_"${DEBIAN_ARCH}".deb
if [ "$?" -ne 0 ]; then
