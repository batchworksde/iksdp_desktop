...
curl --silent --location https://iksdplinux.s3.amazonaws.com/icaclient_26.04.0.105_"${DEBIAN_ARCH}".deb --output "${BUILD_DIR}"/config/packages.chroot/icaclient_26.04.0.105_"${DEBIAN_ARCH}".deb
if [ "$?" -ne 0 ]; then
