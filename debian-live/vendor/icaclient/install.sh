...
curl --silent --location https://iksdplinux.s3.amazonaws.com/icaclient_25.03.0.66_"${DEBIAN_ARCH}".deb --output "${BUILD_DIR}"/config/packages.chroot/icaclient_24.11.0.85_"${DEBIAN_ARCH}".deb
if [ "$?" -ne 0 ]; then
